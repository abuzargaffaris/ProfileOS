...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    excerpt: 'ProfileOS is built around a simple principle: your data should stay yours. Learn how Android Auto Backup and manual JSON/Markdown exports work together to protect your digital profiles with zero cloud tracking.',
    featured: true
  },
  {
